 ...
 *         &lt;element name="simultaneousTaskNumber" type="{http://www.dabi.com/habitv/config/entities}simultaneousTaskNumber" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class Config {
    ...
    protected List<SimultaneousTaskNumber> simultaneousTaskNumber;
    ...
    /**
     * Gets the value of the simultaneousTaskNumber property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the simultaneousTaskNumber property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getSimultaneousTaskNumber().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link SimultaneousTaskNumber }
     * 
     * 
     */
    public List<SimultaneousTaskNumber> getSimultaneousTaskNumber() {
        if (simultaneousTaskNumber == null) {
            simultaneousTaskNumber = new ArrayList<SimultaneousTaskNumber>();
        }
        return this.simultaneousTaskNumber;
    }
