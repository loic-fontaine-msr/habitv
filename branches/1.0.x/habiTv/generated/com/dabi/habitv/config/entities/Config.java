...
// Generated on: 2012.05.01 at 10:15:03 AM CEST 
//
 ...
 *         &lt;element name="simultaneousChannelDownload" type="{http://www.w3.org/2001/XMLSchema}int"/>
 *         &lt;element name="simultaneousEpisodeDownload" type="{http://www.w3.org/2001/XMLSchema}int"/>
 *         &lt;element name="simultaneousExport" type="{http://www.w3.org/2001/XMLSchema}int"/>
 *         &lt;element name="timeBetweenLog" type="{http://www.w3.org/2001/XMLSchema}int"/>
 *         &lt;element name="allDownloadTimeout" type="{http://www.w3.org/2001/XMLSchema}int"/>
 *         &lt;element name="exportTimeout" type="{http://www.w3.org/2001/XMLSchema}int"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "config", propOrder = {
    ...
    "downloader",
    "exporter",
    "simultaneousChannelDownload",
    "simultaneousEpisodeDownload",
    "simultaneousExport",
    "timeBetweenLog",
    "allDownloadTimeout",
    "exportTimeout"
...
public class Config {
    ...
    protected int simultaneousChannelDownload;
    protected int simultaneousEpisodeDownload;
    protected int simultaneousExport;
    protected int timeBetweenLog;
    protected int allDownloadTimeout;
    protected int exportTimeout;
    ...
    /**
     * Gets the value of the simultaneousChannelDownload property.
     * 
     */
    public int getSimultaneousChannelDownload() {
        return simultaneousChannelDownload;
    }

    /**
     * Sets the value of the simultaneousChannelDownload property.
     * 
     */
    public void setSimultaneousChannelDownload(int value) {
        this.simultaneousChannelDownload = value;
    }

    /**
     * Gets the value of the simultaneousEpisodeDownload property.
     * 
     */
    public int getSimultaneousEpisodeDownload() {
        return simultaneousEpisodeDownload;
    }

    /**
     * Sets the value of the simultaneousEpisodeDownload property.
     * 
     */
    public void setSimultaneousEpisodeDownload(int value) {
        this.simultaneousEpisodeDownload = value;
    }

    /**
     * Gets the value of the simultaneousExport property.
     * 
     */
    public int getSimultaneousExport() {
        return simultaneousExport;
    }

    /**
     * Sets the value of the simultaneousExport property.
     * 
     */
    public void setSimultaneousExport(int value) {
        this.simultaneousExport = value;
    }

    /**
     * Gets the value of the timeBetweenLog property.
     * 
     */
    public int getTimeBetweenLog() {
        return timeBetweenLog;
    }

    /**
     * Sets the value of the timeBetweenLog property.
     * 
     */
    public void setTimeBetweenLog(int value) {
        this.timeBetweenLog = value;
    }

    /**
     * Gets the value of the allDownloadTimeout property.
     * 
     */
    public int getAllDownloadTimeout() {
        return allDownloadTimeout;
    }

    /**
     * Sets the value of the allDownloadTimeout property.
     * 
     */
    public void setAllDownloadTimeout(int value) {
        this.allDownloadTimeout = value;
    }

    /**
     * Gets the value of the exportTimeout property.
     * 
     */
    ...
    /**
     * Sets the value of the exportTimeout property.
     * 
     */
    public void setExportTimeout(int value) {
