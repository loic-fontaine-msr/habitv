...
class EpisodeExportIndexRoot implements Serializable {
	...
	public void removeEpisodeExportStates(EpisodeExportState episodeExportState) {
		this.episodeExportStates.remove(episodeExportState);
	}
